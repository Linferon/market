...
public class InputHandler {
    ...
    public static Integer getUpdatedIntegerValue(String fieldName, Integer currentValue) {
        int value = getIntInput("Введие новый " + fieldName + " (или 0, чтобы оставить текущий): ");
        return value == 0 ? currentValue : value;
    }
