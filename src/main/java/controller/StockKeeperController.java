    ...
    private class ProductController {
        ...
        private void addProduct() {
            ExceptionHandler.execute(() -> {
                ...
                productService.addProduct(name, buyPrice, sellPrice);
    ...
    private class StockController {
        ...
        private void updateStockQuantity() {
            ExceptionHandler.execute(() -> {
                ...
                println("Текущий остаток товара '" + currentStock.getProductId() + "': " + currentStock.getQuantity());
    ...
    private class PurchaseController {
        ...
        private void viewPurchases() {
            ExceptionHandler.execute(() -> {
                ...
                showEntitiesTable(purchases, "Список закупок ");
            });
        }
    }
